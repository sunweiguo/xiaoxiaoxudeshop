...
考量了下，发现微信公众号平台挺好的，是一个可以长久维持的平台，并且平台比较方便未来的互动等。所以觉得我写的还不错的话可以关注下：

![image](http://bloghello.oursnail.cn/qrcode_for_gh_7c3862b48f98_258.jpg)

我考虑会将系统学习的知识体系如计算机网络、数据库、redis等都迁移到公众号上，比较清晰，利于管理，如下，朋友们如果想分享自己的文章，微信公众号确实是一个省心省力不少的一个平台：

![image](http://bloghello.oursnail.cn/618b772af1893ac189c2a70d1c340ac.jpg)
